...
<svg class="stlpr-logo-lockup" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 524.1 178.4">
  ...
  />
</svg>`)}},{}],7:[function(e,t,a){"use strict";Object.defineProperty(a,"__esModule",{value:!0}),a.default=void 0;var r=(e=e("../lib/onNavigate"))&&e.__esModule?e:{default:e};function o(e,t){const a=Glade.getDataLayer();e.some(e=>a.tags.includes(e))&&Glade.insertCSS(t)}a.default=function(){for(var e=arguments.length,t=new Array(e),a=0;a<e;a++)t[a]=arguments[a];o(...t),(0,r.default)(()=>o(...t))}},{"../lib/onNavigate":3}],8:[function(e,t,a){"use strict";Object.defineProperty(a,"__esModule",{value:!0}),a.default=void 0;var r=(e=e("../lib/onNavigate"))&&e.__esModule?e:{default:e};function o(){var e;for(e of function(){var e,t=[];for(e of document.querySelectorAll(".RichTextModule")){var a=e.querySelector("h2");a&&a.textContent.toLowerCase().includes("transcript")&&t.push(e)}return t}()){var t=e.querySelector("h2"),a=t.innerHTML,t=(t.remove(),e.innerHTML);e.insertAdjacentHTML("afterend",`
    <section>
