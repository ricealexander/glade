...
`),Glade.components.Placeholder=o}},{}],8:[function(e,t,a){"use strict";Object.defineProperty(a,"__esModule",{value:!0}),a.default=function(){n(),(0,o.default)(()=>n())};var o=(a=e("../lib/onNavigate"))&&a.__esModule?a:{default:a};function n(){var e;for(e of document.querySelectorAll(".RichTextModule")){var t=e.querySelector("h2");t&&(t=t.innerHTML).toLowerCase().includes("transcript")&&(t=`
    ...
    </section>`,e.insertAdjacentHTML("afterend",t),e.remove())}}},{"../lib/onNavigate":3}],9:[function(e,t,a){"use strict";Object.defineProperty(a,"__esModule",{value:!0}),a.default=function(){var e=/[&?]search=grove/.test(window.location.search),t=document.querySelectorAll("form.PH-search-form");if(0===t.length)throw new Error("Could not locate site search forms");if(!e)for(var a of t)a.action="/search"}},{}],10:[function(e,t,a){"use strict";Object.defineProperty(a,"__esModule",{value:!0}),a.default=function(){n(),(0,o.default)(()=>n())};var o=(a=e("../lib/onNavigate"))&&a.__esModule?a:{default:a};function n(){var e=document.documentElement,t=(e.dataset.page=window.location.pathname,document.querySelector('aside[class$="-aside-content"], div[class$="-aside-content"], div[class^=TwoColumnContainer]'));e.dataset.columns=t?2:1}},{"../lib/onNavigate":3}],11:[function(e,t,a){"use strict";Object.defineProperty(a,"__esModule",{value:!0}),a.default=void 0;var o=m(e("./applyThemeByTag")),n=m(e("./addUMSLAttribution")),i=m(e("./animateLogos")),r=m(e("./identifyCurrentPage")),l=m(e("./formatTranscripts")),s=m(e("./googleCustomSearch")),d=m(e("./loadDonateAsk")),u=m(e("./loadDonatePopUp")),c=m(e("./replaceNewsletter")),e=m(e("./components.Placeholder"));function m(e){return e&&e.__esModule?e:{default:e}}n=[{fn:n.default,enabled:!0},{fn:i.default,enabled:!0},{fn:r.default,enabled:!0},{fn:l.default,enabled:!0},{fn:s.default,enabled:!0},{fn:d.default,enabled:!0},{fn:u.default,enabled:!0},{fn:e.default,enabled:!0},{fn:o.default,enabled:!0,args:[["LGBT","LGBTQ"],`
.stlpr-logo .logo-bar {
  stroke-width: 0.5px;
  stroke: currentColor;
}
...
`]},{fn:c.default,enabled:!0,args:["STL Welcome Kit","https://app.e2ma.net/app2/audience/signup/1931618/1784312/","https://app.e2ma.net/app2/audience/signup/1992160/1784312/"]}];a.default=n},{"./addUMSLAttribution":4,"./animateLogos":5,"./applyThemeByTag":6,"./components.Placeholder":7,"./formatTranscripts":8,"./googleCustomSearch":9,"./identifyCurrentPage":10,"./loadDonateAsk":12,"./loadDonatePopUp":13,"./replaceNewsletter":14}],12:[function(e,t,a){"use strict";Object.defineProperty(a,"__esModule",{value:!0}),a.default=function(){u(),i(),(0,o.default)(()=>{u(),i()})};var o=n(e("../lib/onNavigate")),r=n(e("../source"));function n(e){return e&&e.__esModule?e:{default:e}}const l=["Missouri Independent","Capitol News Illinois","ProPublica","River City Journalism Fund","KFF Health News","KSDK","Job Listing","No Donate Ask"];function i(){var e,t,a,o,n,i=document.querySelector(".ArtP-articleBody, .RSEP-articleBody");!i||document.querySelector(".alleg-donate-embed")||r.default.getDataLayer().tags.some(e=>l.includes(e))||i.append(((i=document.createElement("figure")).classList.add("alleg-donate-embed"),i.innerHTML=`
  <!-- Standard Form Data
...
`},{"../lib/onNavigate":3}],14:[function(e,t,a){"use strict";Object.defineProperty(a,"__esModule",{value:!0}),a.default=function(){for(var e=arguments.length,t=new Array(e),a=0;a<e;a++)t[a]=arguments[a];n(...t),(0,o.default)(()=>n(...t))};var o=(a=e("../lib/onNavigate"))&&a.__esModule?a:{default:a};function n(e,t,a){var o=Glade.getDataLayer();if(o.series&&o.series.trim()){var n,o=o.series.trim().split(",");if(o.includes(e))for(n of document.querySelectorAll(`iframe[src="${t}"]`))n.src=a}}},{"../lib/onNavigate":3}],15:[function(e,t,a){"use strict";Object.defineProperty(a,"__esModule",{value:!0}),a.default=void 0;var n=(e=e("../lib/onNavigate"))&&e.__esModule?e:{default:e};a.default=function(e,t,a,o){e.addEventListener(t,a,o),(0,n.default)(()=>{e.removeEventListener(t,a,o)},{once:!0})}},{"../lib/onNavigate":3}],16:[function(e,t,a){"use strict";Object.defineProperty(a,"__esModule",{value:!0}),a.default=void 0,a.default=function(){var e=0<arguments.length&&void 0!==arguments[0]?arguments[0]:{},t=1<arguments.length&&void 0!==arguments[1]?arguments[1]:"",a=e[0],e=e.map(e=>{var{title:e,link:t,display:a}=e;return!1===a?"":`
  ...
  </div>`}},{}],17:[function(e,t,a){"use strict";Object.defineProperty(a,"__esModule",{value:!0}),a.default=void 0,a.default=function(){var e=0<arguments.length&&void 0!==arguments[0]?arguments[0]:{},t=1<arguments.length&&void 0!==arguments[1]?arguments[1]:"";return`
  <div class="ListC">
  ...
  </div>`}},{}],18:[function(e,t,a){"use strict";Object.defineProperty(a,"__esModule",{value:!0}),a.default=void 0,a.default=function(e,t){return`
  <div class="ListD">
  ...
  </div>`}},{}],19:[function(e,t,a){"use strict";Object.defineProperty(a,"__esModule",{value:!0}),a.default=void 0;a.default=e=>{var t,{audio:e,audioFormat:a,episodeID:o,episodeTitle:n,program:i,small:r}=e;if(e)return(t=document.createElement("div")).innerHTML=`
  <ps-stream
  ...
  </ps-stream>`,t;throw new Error("Could not create Audio Button because audio file is missing")}},{}],20:[function(e,t,a){"use strict";Object.defineProperty(a,"__esModule",{value:!0}),a.default=void 0;const o=e=>e?e.trim().split(/,\b/):[];a.default=function(){var e,t=document.querySelector('meta[name="brightspot-dataLayer"]');if(t&&t.content)return(t=JSON.parse(t.content)).pageURL=window.location.pathname,t.authors=(e=t.author||"")?e.trim().split(/,\s/):[],t.categories=o(t.category||""),t.tags=o(t.keywords||""),t;throw new ReferenceError('Failed to locate "brightspot-dataLayer" meta tag.')}},{}],21:[function(e,t,a){"use strict";Object.defineProperty(a,"__esModule",{value:!0}),a.default=void 0;var o=p(e("./addIsolatedEventListener")),n=p(e("./getDataLayer")),i=p(e("./insertCSS")),r=p(e("./insertScript")),l=p(e("./insertStylesheet")),s=p(e("./pageMatches")),d=p(e("./setIsolatedInterval")),u=p(e("./components/ListB")),c=p(e("./components/ListC")),m=p(e("./components/ListD")),e=p(e("./components/StreamPill"));function p(e){return e&&e.__esModule?e:{default:e}}const f={insertCSS:i.default,insertScript:r.default,insertStylesheet:l.default,addIsolatedEventListener:o.default,setIsolatedInterval:d.default,getDataLayer:n.default,pageMatches:s.default,components:{ListB:u.default,ListC:c.default,ListD:m.default,StreamPill:e.default},onNavigate:[]};f.currentPage=window.location.pathname,setInterval(()=>{var e=window.location.pathname,t=f.currentPage;e!==t&&(t=new CustomEvent("grove-navigate",{detail:{page:e,previousPage:t}}),window.dispatchEvent(t),f.currentPage=e)},100);i=f;a.default=i},{"./addIsolatedEventListener":15,"./components/ListB":16,"./components/ListC":17,"./components/ListD":18,"./components/StreamPill":19,"./getDataLayer":20,"./insertCSS":22,"./insertScript":23,"./insertStylesheet":24,"./pageMatches":25,"./setIsolatedInterval":26}],22:[function(e,t,a){"use strict";Object.defineProperty(a,"__esModule",{value:!0}),a.default=void 0;var n=(e=e("../lib/onNavigate"))&&e.__esModule?e:{default:e};const i=[];a.default=function(e){var t,a=1<arguments.length&&void 0!==arguments[1]&&arguments[1];for(t of i)if(t.textContent==e)return;const o=document.createElement("style");return o.textContent=e,document.head.insertAdjacentElement("beforeend",o),a||(0,n.default)(()=>o.remove(),{once:!0}),o}},{"../lib/onNavigate":3}],23:[function(e,t,a){"use strict";Object.defineProperty(a,"__esModule",{value:!0}),a.default=void 0;var i=o(e("../lib/onNavigate")),r=o(e("../lib/applyAttributes"));function o(e){return e&&e.__esModule?e:{default:e}}a.default=function(e){var t=1<arguments.length&&void 0!==arguments[1]&&arguments[1];if(!e||!e.src)throw new ReferenceError('Script src is required. Use syntax Glade.insertScript({src: "PATH"})');var a=[...document.querySelectorAll("script[src]")],o=a.map(e=>e.scr);if(!o.includes(e.src)){const n=document.createElement("script");return(0,r.default)(n,e),a[a.length-1].after(n),t||(0,i.default)(()=>n.remove(),{once:!0}),n}}},{"../lib/applyAttributes":2,"../lib/onNavigate":3}],24:[function(e,t,a){"use strict";Object.defineProperty(a,"__esModule",{value:!0}),a.default=void 0;var i=o(e("../lib/onNavigate")),r=o(e("../lib/applyAttributes"));function o(e){return e&&e.__esModule?e:{default:e}}a.default=function(e){var t=1<arguments.length&&void 0!==arguments[1]&&arguments[1];if(!e||!e.href)throw new ReferenceError('Stylesheet href is required. Use syntax Glade.insertStylesheet({href: "PATH"})');var a=[...document.querySelectorAll("link[rel=stylesheet]")],o=a.map(e=>e.href);if(!o.includes(e.href)){const n=document.createElement("link");return n.rel="stylesheet",(0,r.default)(n,e),a[a.length-1].after(n),t||(0,i.default)(()=>n.remove(),{once:!0}),n}}},{"../lib/applyAttributes":2,"../lib/onNavigate":3}],25:[function(e,t,a){"use strict";Object.defineProperty(a,"__esModule",{value:!0}),a.default=void 0,a.default=function(){const a=window.location.pathname;for(var e=arguments.length,t=new Array(e),o=0;o<e;o++)t[o]=arguments[o];return t.some(e=>{var t=a;if("string"==typeof e)return t===e;if(e instanceof RegExp)return e.test(t);if("function"==typeof e)return e(t);throw new Error(`Criterion must be a String, Regular Expression, or Function. Instead got ${typeof e}, `+e)})}},{}],26:[function(e,t,a){"use strict";Object.defineProperty(a,"__esModule",{value:!0}),a.default=void 0;var o=(e=e("../lib/onNavigate"))&&e.__esModule?e:{default:e};a.default=function(e,t){const a=setInterval(e,t);return(0,o.default)(()=>{clearInterval(a)},{once:!0}),a}},{"../lib/onNavigate":3}]},{},[1]);