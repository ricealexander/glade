...
`,!0),n(),(0,o.default)(()=>n())}},{"../lib/onNavigate":3}],7:[function(e,t,a){"use strict";Object.defineProperty(a,"__esModule",{value:!0}),a.default=void 0;var o=(e=e("../lib/onNavigate"))&&e.__esModule?e:{default:e};function r(e,t){const a=Glade.getDataLayer();e.some(e=>a.tags.includes(e))&&Glade.insertCSS(t)}a.default=function(){for(var e=arguments.length,t=new Array(e),a=0;a<e;a++)t[a]=arguments[a];r(...t),(0,o.default)(()=>r(...t))}},{"../lib/onNavigate":3}],8:[function(e,t,a){"use strict";Object.defineProperty(a,"__esModule",{value:!0}),a.default=void 0;var o=(e=e("../lib/onNavigate"))&&e.__esModule?e:{default:e};function r(){var e;for(e of function(){var e,t=[];for(e of document.querySelectorAll(".RichTextModule")){var a=e.querySelector("h2");a&&a.textContent.toLowerCase().includes("transcript")&&t.push(e)}return t}()){var t=e.querySelector("h2"),a=t.innerHTML,t=(t.remove(),e.innerHTML);e.insertAdjacentHTML("afterend",`
    <section>
