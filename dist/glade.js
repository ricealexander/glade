...
`,!0),n(),(0,o.default)(()=>n())}},{"../lib/onNavigate":3}],7:[function(e,t,a){"use strict";Object.defineProperty(a,"__esModule",{value:!0}),a.default=void 0;var o=(e=e("../lib/onNavigate"))&&e.__esModule?e:{default:e};function r(e,t){const a=Glade.getDataLayer();e.some(e=>a.tags.includes(e))&&Glade.insertCSS(t)}a.default=function(){for(var e=arguments.length,t=new Array(e),a=0;a<e;a++)t[a]=arguments[a];r(...t),(0,o.default)(()=>r(...t))}},{"../lib/onNavigate":3}],8:[function(e,t,a){"use strict";Object.defineProperty(a,"__esModule",{value:!0}),a.default=void 0;const r=/^(\d+):(\d+)$/;function o(){var e,t,a=0<arguments.length&&void 0!==arguments[0]?arguments[0]:"4:3",o=1<arguments.length&&void 0!==arguments[1]?arguments[1]:"Placeholder "+a;if("string"==typeof a&&r.test(a))return[,e,t]=a.match(r),`
...
`),Glade.components.Placeholder=o}},{}],9:[function(e,t,a){"use strict";Object.defineProperty(a,"__esModule",{value:!0}),a.default=void 0;var o=(e=e("../lib/onNavigate"))&&e.__esModule?e:{default:e};function r(){var e;for(e of document.querySelectorAll(".RichTextModule")){var t=e.querySelector("h2");t&&(t=t.innerHTML).toLowerCase().includes("transcript")&&(t=`
    <section>
    ...
    </section>`,e.insertAdjacentHTML("afterend",t),e.remove())}}a.default=()=>{r(),(0,o.default)(()=>r())}},{"../lib/onNavigate":3}],10:[function(e,t,a){"use strict";Object.defineProperty(a,"__esModule",{value:!0}),a.default=void 0;a.default=()=>{var e=/[&?]search=grove/.test(window.location.search),t=document.querySelectorAll("form.PH-search-form");if(0===t.length)throw new Error("Could not locate site search forms");if(!e)for(var a of t)a.action="/search"}},{}],11:[function(e,t,a){"use strict";Object.defineProperty(a,"__esModule",{value:!0}),a.default=void 0;var o=(e=e("../lib/onNavigate"))&&e.__esModule?e:{default:e};function r(){var e=document.documentElement,t=(e.dataset.page=window.location.pathname,document.querySelector('aside[class$="-aside-content"], div[class$="-aside-content"], div[class^=TwoColumnContainer]'));e.dataset.columns=t?2:1}a.default=()=>{r(),(0,o.default)(()=>r())}},{"../lib/onNavigate":3}],12:[function(e,t,a){"use strict";Object.defineProperty(a,"__esModule",{value:!0}),a.default=void 0;var o=u(e("./applyThemeByTag")),r=u(e("./addUMSLAttribution")),i=u(e("./animateLogos")),n=u(e("./identifyCurrentPage")),l=u(e("./IEBannerMessage")),s=u(e("./formatTranscripts")),d=u(e("./googleCustomSearch")),e=u(e("./components.Placeholder"));function u(e){return e&&e.__esModule?e:{default:e}}r=[{fn:r.default,enabled:!0},{fn:i.default,enabled:!0},{fn:n.default,enabled:!0},{fn:s.default,enabled:!0},{fn:d.default,enabled:!0},{fn:e.default,enabled:!0},{fn:o.default,enabled:!0,args:[["LGBT","LGBTQ"],`
.stlpr-logo .logo-bar {
  stroke-width: 0.5px;
  stroke: currentColor;
}
...
`]},{fn:l.default,enabled:!1,args:["Not all features may be supported in Internet Explorer"]}];a.default=r},{"./IEBannerMessage":4,"./addUMSLAttribution":5,"./animateLogos":6,"./applyThemeByTag":7,"./components.Placeholder":8,"./formatTranscripts":9,"./googleCustomSearch":10,"./identifyCurrentPage":11}],13:[function(e,t,a){"use strict";Object.defineProperty(a,"__esModule",{value:!0}),a.default=void 0,a.default=function(a,o,r){const i=()=>window.location.pathname,n=i();a.addEventListener(o,function e(t){n!==i()?a.removeEventListener(o,e):r(t)})}},{}],14:[function(e,t,a){"use strict";Object.defineProperty(a,"__esModule",{value:!0}),a.default=void 0,a.default=function(){var e=0<arguments.length&&void 0!==arguments[0]?arguments[0]:{},t=1<arguments.length&&void 0!==arguments[1]?arguments[1]:"",a=e[0],e=e.map(e=>{var{title:e,link:t,display:a}=e;return!1===a?"":`
