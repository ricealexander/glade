...
</div>`;function l(){var e=document.querySelector("footer .Page-footer-columns");e?e.insertAdjacentHTML("beforeend",i):console.error("Could not find footer navigation for UMSL Attribution.")}a.default=()=>{var e;Glade.insertCSS(`
...
`,!0),(e=document.querySelector(".PH-ham-m-wrapper"))?e.insertAdjacentHTML("beforeend",r):console.error("Could not find menu container for UMSL Attribution."),l(),(0,o.default)(()=>l())}},{"../lib/onNavigate":3}],5:[function(e,t,a){"use strict";Object.defineProperty(a,"__esModule",{value:!0}),a.default=void 0;var o=(e=e("../lib/onNavigate"))&&e.__esModule?e:{default:e};const r=`
<svg
  class="stlpr-logo"
...
<svg class="stlpr-logo-lockup" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 524.1 178.4">
  ...
  />
</svg>`;function l(){var e=document.querySelector('.PH-top-bar .PH-logo a[aria-label="home page"]'),e=(e?e.innerHTML=r+i:console.error('Could not find logo container ".PH-top-bar .PH-logo a[aria-label="home page"]".'),document.querySelector('.PH-ham-m .PH-logo a[aria-label="home page"]'));e?e.innerHTML=r:console.log('Could not find logo container ".PH-ham-m .PH-logo a[aria-label="home page"]".')}a.default=()=>{Glade.insertCSS(`
.PH-logo {
...
`,!0),l(),(0,o.default)(()=>l())}},{"../lib/onNavigate":3}],6:[function(e,t,a){"use strict";Object.defineProperty(a,"__esModule",{value:!0}),a.default=void 0;var o=(e=e("../lib/onNavigate"))&&e.__esModule?e:{default:e};function r(e,t){const a=Glade.getDataLayer();e.some(e=>a.tags.includes(e))&&Glade.insertCSS(t)}a.default=function(){for(var e=arguments.length,t=new Array(e),a=0;a<e;a++)t[a]=arguments[a];r(...t),(0,o.default)(()=>r(...t))}},{"../lib/onNavigate":3}],7:[function(e,t,a){"use strict";Object.defineProperty(a,"__esModule",{value:!0}),a.default=void 0;const r=/^(\d+):(\d+)$/;function o(){var e,t,a=0<arguments.length&&void 0!==arguments[0]?arguments[0]:"4:3",o=1<arguments.length&&void 0!==arguments[1]?arguments[1]:"Placeholder "+a;if("string"==typeof a&&r.test(a))return[,e,t]=a.match(r),`
...
`),Glade.components.Placeholder=o}},{}],8:[function(e,t,a){"use strict";Object.defineProperty(a,"__esModule",{value:!0}),a.default=void 0;var o=(e=e("../lib/onNavigate"))&&e.__esModule?e:{default:e};function r(){var e;for(e of document.querySelectorAll(".RichTextModule")){var t=e.querySelector("h2");t&&(t=t.innerHTML).toLowerCase().includes("transcript")&&(t=`
    <section>
    ...
    </section>`,e.insertAdjacentHTML("afterend",t),e.remove())}}a.default=()=>{r(),(0,o.default)(()=>r())}},{"../lib/onNavigate":3}],9:[function(e,t,a){"use strict";Object.defineProperty(a,"__esModule",{value:!0}),a.default=void 0;a.default=()=>{var e=/[&?]search=grove/.test(window.location.search),t=document.querySelectorAll("form.PH-search-form");if(0===t.length)throw new Error("Could not locate site search forms");if(!e)for(var a of t)a.action="/search"}},{}],10:[function(e,t,a){"use strict";Object.defineProperty(a,"__esModule",{value:!0}),a.default=void 0;var o=(e=e("../lib/onNavigate"))&&e.__esModule?e:{default:e};function r(){var e=document.documentElement,t=(e.dataset.page=window.location.pathname,document.querySelector('aside[class$="-aside-content"], div[class$="-aside-content"], div[class^=TwoColumnContainer]'));e.dataset.columns=t?2:1}a.default=()=>{r(),(0,o.default)(()=>r())}},{"../lib/onNavigate":3}],11:[function(e,t,a){"use strict";Object.defineProperty(a,"__esModule",{value:!0}),a.default=void 0;var o=d(e("./applyThemeByTag")),r=d(e("./addUMSLAttribution")),i=d(e("./animateLogos")),l=d(e("./identifyCurrentPage")),n=d(e("./formatTranscripts")),s=d(e("./googleCustomSearch")),e=d(e("./components.Placeholder"));function d(e){return e&&e.__esModule?e:{default:e}}r=[{fn:r.default,enabled:!0},{fn:i.default,enabled:!0},{fn:l.default,enabled:!0},{fn:n.default,enabled:!0},{fn:s.default,enabled:!0},{fn:e.default,enabled:!0},{fn:o.default,enabled:!0,args:[["LGBT","LGBTQ"],`
.stlpr-logo .logo-bar {
  stroke-width: 0.5px;
  stroke: currentColor;
}
...
`]}];a.default=r},{"./addUMSLAttribution":4,"./animateLogos":5,"./applyThemeByTag":6,"./components.Placeholder":7,"./formatTranscripts":8,"./googleCustomSearch":9,"./identifyCurrentPage":10}],12:[function(e,t,a){"use strict";Object.defineProperty(a,"__esModule",{value:!0}),a.default=void 0;var r=(e=e("../lib/onNavigate"))&&e.__esModule?e:{default:e};a.default=function(e,t,a,o){e.addEventListener(t,a,o),(0,r.default)(()=>{e.removeEventListener(t,a,o)},{once:!0})}},{"../lib/onNavigate":3}],13:[function(e,t,a){"use strict";Object.defineProperty(a,"__esModule",{value:!0}),a.default=void 0,a.default=function(){var e=0<arguments.length&&void 0!==arguments[0]?arguments[0]:{},t=1<arguments.length&&void 0!==arguments[1]?arguments[1]:"",a=e[0],e=e.map(e=>{var{title:e,link:t,display:a}=e;return!1===a?"":`
  ...
  </div>`}},{}],16:[function(e,t,a){"use strict";Object.defineProperty(a,"__esModule",{value:!0}),a.default=void 0;a.default=e=>{var t,{audio:e,audioFormat:a,episodeID:o,episodeTitle:r,program:i,small:l}=e;if(e)return(t=document.createElement("div")).innerHTML=`
  <ps-stream
