!function r(o,i,n){function l(t,e){if(!i[t]){if(!o[t]){var a="function"==typeof require&&require;if(!e&&a)return a(t,!0);if(s)return s(t,!0);throw(e=new Error("Cannot find module '"+t+"'")).code="MODULE_NOT_FOUND",e}a=i[t]={exports:{}},o[t][0].call(a.exports,function(e){return l(o[t][1][e]||e)},a,a.exports,r,o,i,n)}return i[t].exports}for(var s="function"==typeof require&&require,e=0;e<n.length;e++)l(n[e]);return l}({1:[function(e,t,a){"use strict";var r=i(e("./source")),o=i(e("./plugins"));function i(e){return e&&e.__esModule?e:{default:e}}window.Glade=r.default,document.addEventListener("DOMContentLoaded",()=>{for(const r of o.default){var e=r.enabled,t=r.fn,a=r.args||[];try{e&&t(...a)}catch(e){console.error(e)}}})},{"./plugins":11,"./source":19}],2:[function(e,t,a){"use strict";Object.defineProperty(a,"__esModule",{value:!0}),a.default=void 0,a.default=function(e){var t,a;for([t,a]of Object.entries(1<arguments.length&&void 0!==arguments[1]?arguments[1]:{}))"boolean"==typeof a?a&&e.setAttribute(t,""):e.setAttribute(t,a)}},{}],3:[function(e,t,a){"use strict";Object.defineProperty(a,"__esModule",{value:!0}),a.default=void 0,a.default=function(e){let t=1<arguments.length&&void 0!==arguments[1]?arguments[1]:void 0;return setTimeout(()=>{window.addEventListener("grove-navigate",e,t)},100),window.Glade.onNavigate.push([e.toString(),{callback:e,options:t}]),()=>{window.removeEventListener("grove-navigate",e,t)}}},{}],4:[function(e,t,a){"use strict";Object.defineProperty(a,"__esModule",{value:!0}),a.default=void 0;var r=(e=e("../lib/onNavigate"))&&e.__esModule?e:{default:e};function o(e){if(e){var e=`
  ...
  </div>`,t=document.querySelector(".AlertBar");if(t)t.insertAdjacentHTML("beforebegin",e);else{var a,t=document.querySelector(".Page-above");if(!t)throw(a=document.querySelector("ps-header"))&&a.insertAdjacentHTML("afterend",e),new Error("No locations to place an alert bar were found.");t.insertAdjacentHTML("afterend",e)}}}a.default=e=>{(window.navigator.userAgent||"").toLowerCase().includes("trident")&&(o(e),(0,r.default)(()=>o(e)))}},{"../lib/onNavigate":3}],5:[function(e,t,a){"use strict";Object.defineProperty(a,"__esModule",{value:!0}),a.default=void 0;var r=(e=e("../lib/onNavigate"))&&e.__esModule?e:{default:e};function o(e,t){if(!brightspotDataLayer)throw new ReferenceError("Could not read Brightspot Data Layer.");if(!brightspotDataLayer.keywords||!brightspotDataLayer.keywords.trim())throw new ReferenceError(`Could not read Tags from Data Layer, "${brightspotDataLayer.keywords}".`);const a=brightspotDataLayer.keywords.trim().split(",");e.any(e=>a.includes(e))&&Glade.insertCSS(t)}a.default=function(){for(var e=arguments.length,t=new Array(e),a=0;a<e;a++)t[a]=arguments[a];o(),(0,r.default)(()=>o(...t))}},{"../lib/onNavigate":3}],6:[function(e,t,a){"use strict";Object.defineProperty(a,"__esModule",{value:!0}),a.default=void 0;var r=(e=e("../lib/onNavigate"))&&e.__esModule?e:{default:e};e=`
...
<svg class="stlpr-logo-lockup" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 524.1 178.4">
  ...
  />
</svg>`)}},{}],8:[function(e,t,a){"use strict";Object.defineProperty(a,"__esModule",{value:!0}),a.default=void 0;var r=(e=e("../lib/onNavigate"))&&e.__esModule?e:{default:e};function o(){var e;for(e of function(){var e,t=[];for(e of document.querySelectorAll(".RichTextModule")){var a=e.querySelector("h2");a&&a.textContent.toLowerCase().includes("transcript")&&t.push(e)}return t}()){var t=e.querySelector("h2"),a=t.innerHTML,t=(t.remove(),e.innerHTML);e.insertAdjacentHTML("afterend",`
    <section>
...
`;let i;function n(){var e=0<arguments.length&&void 0!==arguments[0]?arguments[0]:"4:3",t=1<arguments.length&&void 0!==arguments[1]?arguments[1]:"Placeholder "+e;if("string"!=typeof e)throw new TypeError(`expected String. Instead got ${typeof e}, `+e);if(!r.test(e))throw new Error('aspectRatio must be in format width:height (e.g. "16:9"). Instead got '+e);i=i||Glade.insertCSS(o);var[,e,a]=e.match(r),a=Number(a)/Number(e),e=document.createElement("div");return e.className="placeholder-frame",e.style=`padding-top: ${function(e,t){return t=1<arguments.length&&void 0!==t?t:0,Math.round(e*10**t)/10**t}(100*a,5)}%`,e.innerHTML=`<div class="placeholder-inner">${t}</div>`,e}a.default=()=>{Glade.makePlaceholder=n}},{}],13:[function(e,t,a){"use strict";Object.defineProperty(a,"__esModule",{value:!0}),a.default=void 0,a.default=function(a,r,o){const i=()=>window.location.pathname,n=i();a.addEventListener(r,function e(t){n!==i()?a.removeEventListener(r,e):o(t)})}},{}],14:[function(e,t,a){"use strict";Object.defineProperty(a,"__esModule",{value:!0}),a.default=void 0,a.default=function(){var e=0<arguments.length&&void 0!==arguments[0]?arguments[0]:{},t=1<arguments.length&&void 0!==arguments[1]?arguments[1]:"",a=e[0],e=e.map(e=>{var{title:e,link:t,display:a}=e;return!1===a?"":`
  ...
  </ps-stream>`,t;throw new Error("Could not create Audio Button because audio file is missing")}},{}],18:[function(e,t,a){"use strict";Object.defineProperty(a,"__esModule",{value:!0}),a.default=void 0;const r=e=>e?e.split(/,\b/):[];a.default=function(){if(!brightspotDataLayer)throw new ReferenceError("Could not read Brightspot Data Layer.");if(brightspotDataLayer.keywords&&brightspotDataLayer.keywords.trim())return{storyTitle:brightspotDataLayer.storyTitle||document.querySelector("h1")?.textContent||document.title,pageType:brightspotDataLayer.pageType||"",program:brightspotDataLayer.program||"",timezone:brightspotDataLayer.timezone||"US/Central",hasInlineAudio:!!brightspotDataLayer.inlineAudio,publishedDate:brightspotDataLayer.publishedDate?new Date(brightspotDataLayer.publishedDate):"",authors:r(brightspotDataLayer.author||""),categories:r(brightspotDataLayer.category||""),tags:r(brightspotDataLayer.keywords||""),brightspotStoryID:brightspotDataLayer.bspStoryId||null,NPRStoryID:brightspotDataLayer.nprStoryId||null,stationID:brightspotDataLayer.stationOrgId||null,station:brightspotDataLayer.station||"St. Louis Public Radio",siteName:brightspotDataLayer.siteName||"STLPR",isNPRStation:brightspotDataLayer.nprCmsSite||!1};throw new ReferenceError(`Could not read Tags from Data Layer, "${brightspotDataLayer.keywords}".`)}},{}],19:[function(e,t,a){"use strict";Object.defineProperty(a,"__esModule",{value:!0}),a.default=void 0;var r=m(e("./addIsolatedEventListener")),o=m(e("./getMetadata")),i=m(e("./insertCSS")),n=m(e("./insertScript")),l=m(e("./insertStylesheet")),s=m(e("./pageMatches")),d=m(e("./setIsolatedInterval")),u=m(e("./components/ListB")),c=m(e("./components/ListC")),f=m(e("./components/ListD")),e=m(e("./components/StreamPill"));function m(e){return e&&e.__esModule?e:{default:e}}const p={insertCSS:i.default,insertScript:n.default,insertStylesheet:l.default,addIsolatedEventListener:r.default,setIsolatedInterval:d.default,getMetadata:o.default,pageMatches:s.default,components:{ListB:u.default,ListC:c.default,ListD:f.default,StreamPill:e.default},onNavigate:[]};p.currentPage=window.location.pathname,setInterval(()=>{var e=window.location.pathname,t=p.currentPage;e!==t&&(t=new CustomEvent("grove-navigate",{detail:{page:e,previousPage:t}}),window.dispatchEvent(t),p.currentPage=e)},100);i=p;a.default=i},{"./addIsolatedEventListener":13,"./components/ListB":14,"./components/ListC":15,"./components/ListD":16,"./components/StreamPill":17,"./getMetadata":18,"./insertCSS":20,"./insertScript":21,"./insertStylesheet":22,"./pageMatches":23,"./setIsolatedInterval":24}],20:[function(e,t,a){"use strict";Object.defineProperty(a,"__esModule",{value:!0}),a.default=void 0;var r=(e=e("../lib/onNavigate"))&&e.__esModule?e:{default:e};a.default=function(e){var t=1<arguments.length&&void 0!==arguments[1]&&arguments[1];const a=document.createElement("style");return a.textContent=e,document.head.insertAdjacentElement("beforeend",a),t||(0,r.default)(()=>a.remove(),{once:!0}),a}},{"../lib/onNavigate":3}],21:[function(e,t,a){"use strict";Object.defineProperty(a,"__esModule",{value:!0}),a.default=void 0;var i=r(e("../lib/onNavigate")),n=r(e("../lib/addAttributes"));function r(e){return e&&e.__esModule?e:{default:e}}a.default=function(){var e=0<arguments.length&&void 0!==arguments[0]?arguments[0]:{},t=1<arguments.length&&void 0!==arguments[1]&&arguments[1],a=[...document.querySelectorAll("script")],r=a.filter(e=>e.src);if(!e.src)throw new Error('Script src is required. Use syntax Glade.insertScript({src: "PATH"})');if(!r.includes(e.src)){const o=document.createElement("script");return(0,n.default)(o,e),a[a.length-1].after(o),t||(0,i.default)(()=>o.remove(),{once:!0}),o}}},{"../lib/addAttributes":2,"../lib/onNavigate":3}],22:[function(e,t,a){"use strict";Object.defineProperty(a,"__esModule",{value:!0}),a.default=void 0;var i=r(e("../lib/onNavigate")),n=r(e("../lib/addAttributes"));function r(e){return e&&e.__esModule?e:{default:e}}a.default=function(){var e=0<arguments.length&&void 0!==arguments[0]?arguments[0]:{},t=1<arguments.length&&void 0!==arguments[1]&&arguments[1],a=[...document.querySelectorAll("link")],r=a.filter(e=>"stylesheet"===e.rel);if(!e.href)throw new Error('Stylesheet href is required. Use syntax Glade.insertStylesheet({href: "PATH"})');if(r.includes(e.href))throw new Error("Refused to Load Stylesheet: already present in the page source");var o=document.createElement("link");return(0,n.default)(o,e),o.rel="stylesheet",a[a.length-1].after(o),t||(0,i.default)(()=>o.remove(),{once:!0}),o}},{"../lib/addAttributes":2,"../lib/onNavigate":3}],23:[function(e,t,a){"use strict";Object.defineProperty(a,"__esModule",{value:!0}),a.default=void 0,a.default=function(){const a=window.location.pathname;for(var e=arguments.length,t=new Array(e),r=0;r<e;r++)t[r]=arguments[r];return t.some(e=>{var t=a;if("string"==typeof e)return t===e;if(e instanceof RegExp)return e.test(t);if("function"==typeof e)return e(t);throw new Error(`Criteria must be a String, Regular Expression, or Function. Instead got ${typeof e}, `+e)})}},{}],24:[function(e,t,a){"use strict";Object.defineProperty(a,"__esModule",{value:!0}),a.default=void 0,a.default=function(e,t){const a=()=>window.location.pathname,r=a();let o;return o=setInterval(function(){r!==a()?clearInterval(o):e()},t)}},{}]},{},[1]);